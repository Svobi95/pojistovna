...
<div class="row  d-flex justify-content-center ">
	<div class="col-sm-auto flex-grow-1">
		...
		<input type="text" class="form-control" placeholder="Jméno" id="first_name" name="first_name" value="'.$first_name.'">
	</div>
	<div class="col-sm-auto flex-grow-1">
		<label for="second_name">Příjmení</label>
		<input type="text" class="form-control" placeholder="Příjmení" id="second_name" name="second_name" value="'.$second_name.'">
	</div>
</div>
<div class="row d-flex">
	<div class="col-sm-auto flex-grow-1">
		<label for="age">Věk</label>
		<input type="number" class="form-control" placeholder="Věk klienta" id="age" name="age" value="'.$age.'">
	</div>
	<div class="col-sm-auto flex-grow-1">
		<label for="phone">Telefon</label>
		<input type="tel" class="form-control" id="phone" name="phone"  placeholder="+420 123 456 789" title="Zadejte platné telefonníní číslo" value="'.$phone.'">
	</div>
</div>
